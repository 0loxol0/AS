...
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m au : Alzwage 
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m fb : fb.com/ahmedAlzwage.02
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m gh : github.com/ahmedAlzwage
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m——————————————————————————————
""")
...
free_h={"Host":"Api.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
...
def bot_follow():
	...
	kata_utama2 = random.choice(["Hai bro 😎","Hello bro 😎","Hello Bro 😎","Hai Bro 😎"])
	komen2 = kata_utama2+"\n"+kata_mutiara_islam+"\n"+waktu
		...
		if len(i)<3:
			...
			if len(i)==1 or len(i)==2 or len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "Pakistan" in country:
					results.append("20002000,19991999")
